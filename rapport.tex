...
\begin{figure}
	...
	\end{subfigure}
	\caption{Diffusion pour differents $\kappa$}
\end{figure}

On voit qu'il y a une plus grande diffusion plus $\kappa$ est grand. Cela est coherent etant donne que $\kappa$ est le coefficient qui quantifie la diffusion. Le schema semble bien donner la reponse attendue.
